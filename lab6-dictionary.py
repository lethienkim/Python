...
def main():
    ...
    restaurant = {}
    # File declaration
    outfile=open("lab6b-dictionary",'w')
    ...
    print('\n')
    outfile.close()
    dymmy=input("Please enter any key to continue: ")
    

def loadrec(aDict):
    
    # 0=restname,1=foodtype,2=reservation,3=rating,4=creditcard
    # local variable
    k=0
